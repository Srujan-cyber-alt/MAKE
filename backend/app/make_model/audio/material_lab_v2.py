...
MATERIAL_PROFILES: Dict[str, MaterialProfile] = {
    "wood": MaterialProfile("wood", 600, 12e9, 0.05, 0.3, 450, [120, 250, 400, 550], 0.4, "#8B4513"),
    "metal": MaterialProfile("metal", 7800, 200e9, 0.01, 0.1, 1200, [220, 440, 660, 880], 0.1, "#C0C0C0"),
    "glass": MaterialProfile("glass", 2500, 70e9, 0.02, 0.15, 1500, [523, 660, 784, 1047], 0.05, "#87CEEB"),
    "plastic": MaterialProfile("plastic", 1200, 3e9, 0.08, 0.4, 300, [220, 440, 660, 880], 0.6, "#00FF00"),
    "stone": MaterialProfile("stone", 2700, 50e9, 0.03, 0.5, 800, [110, 220, 330, 440], 0.3, "#808080"),
    "concrete": MaterialProfile("concrete", 2400, 30e9, 0.06, 0.6, 600, [100, 200, 300, 400], 0.4, "#A9A9A9"),
    "ceramic": MaterialProfile("ceramic", 2100, 300e9, 0.04, 0.35, 1100, [440, 660, 880, 1100], 0.2, "#E0E0E0"),
    "rubber": MaterialProfile("rubber", 1100, 0.01e9, 0.25, 0.8, 50, [80, 160, 240, 320], 0.8, "#FF0000"),
    "fabric": MaterialProfile("fabric", 150, 0.5e9, 0.3, 0.7, 300, [200, 400, 600, 800], 0.9, "#4B0082"),
    "water": MaterialProfile("water", 1000, 2e9, 0.001, 0.0, 100, [60, 120, 180, 240], 0.2, "#0000FF"),
    "ice": MaterialProfile("ice", 920, 10e9, 0.015, 0.2, 800, [440, 660, 880, 1100], 0.15, "#E0FFFF"),
    "paper": MaterialProfile("paper", 800, 0.4e9, 0.12, 0.9, 200, [440, 880, 1320], 0.7, "#FFFFE0"),
    "leather": MaterialProfile("leather", 900, 0.2e9, 0.15, 0.65, 250, [200, 400, 600, 800], 0.75, "#8B0000"),
    "sand": MaterialProfile("sand", 1600, 0.1e9, 0.5, 1.0, 100, [50, 100, 150, 200], 0.95, "#F4A460"),
    "dirt": MaterialProfile("dirt", 1400, 0.05e9, 0.6, 0.8, 80, [40, 80, 120, 160], 0.9, "#8B4513"),
    "foliage": MaterialProfile("foliage", 400, 0.01e9, 0.4, 0.9, 200, [300, 600, 900, 1200], 0.85, "#228B22"),
    "snow": MaterialProfile("snow", 100, 0.01e9, 0.8, 0.9, 50, [80, 160, 240, 320], 0.95, "#FFFFFF"),
    "mud": MaterialProfile("mud", 1800, 0.02e9, 0.7, 0.85, 60, [60, 120, 180, 240], 0.9, "#5C4033"),
}
