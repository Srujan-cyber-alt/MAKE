...
def auth_client():
    ...
    client.post("/api/v1/auth/register", json={"email": "v2single@test.com", "password": "testpass123"})
    login = client.post("/api/v1/auth/token", data={"username": "v2single@test.com", "password": "testpass123"})
...
class TestIntelligenceV2API:
    ...
    def test_cancel_job(self, auth_client):
        client, headers = auth_client
    ...
    def test_get_job_events(self, auth_client):
        client, headers = auth_client
    ...
    def test_get_job_artifacts(self, auth_client):
        client, headers = auth_client
    ...
    def test_get_job_trace(self, auth_client):
        client, headers = auth_client
    ...
    def test_get_job_status(self, auth_client):
        client, headers = auth_client
